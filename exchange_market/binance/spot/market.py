...
def get_klines(self, symbol: str, interval: str, **kwargs):
    ...
    Keyword Args:
        limit (int, optional): limit the results. Default 500; max 1000.
        startTime (int, optional): Timestamp in ms to get aggregate trades from INCLUSIVE., 毫秒
        endTime (int, optional): Timestamp in ms to get aggregate trades until INCLUSIVE.  毫秒
    """
