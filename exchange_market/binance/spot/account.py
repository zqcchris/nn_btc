...
from exchange_market.binance.lib.utils import check_required_parameters
...
def new_order(self, symbol: str, side: str, type: str, account: AccountBinance = None, **kwargs):
    """New Order (TRADE)
    ...
    return self.sign_request("POST", url_path, params, account=account)
...
def account(self, account: AccountBinance = None, **kwargs):
    ...
    return self.sign_request("GET", url_path, {**kwargs}, account)
